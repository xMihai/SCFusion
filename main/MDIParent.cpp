...
#include "bitmaps/GambitF256.xpm"
...
MyFrame::MyFrame()
: wxMDIParentFrame(NULL, wxID_ANY, "StarCraft Gambit", wxDefaultPosition, wxDefaultSize, wxDEFAULT_FRAME_STYLE|wxMAXIMIZE)
, m_version(NULL)
{
	wxIcon icon(GambitF256Icon);
	SetIcon(icon);
...
{
	(void)wxMessageBox("StarCraft Gambit\n"
		"v2.0.0\n"
		"Author: Andrew Armstrong\n"
		"Maintainer: Mihai Raducanu"
		, "About StarCraft Gambit");
}
